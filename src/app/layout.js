...
export const metadata = {
    ...
    description: 'Организуем перевод пациента в другую клинику или стационар. Медицинский транспорт, сопровождение, помощь с документами и приёмом. Работаем 24/7.',
